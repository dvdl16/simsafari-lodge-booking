export const environment = {
  production: true,
  apiUrl: 'https://aiy3dcdty8.execute-api.eu-west-1.amazonaws.com/beta',
  ...
  iNatApiUrl: 'https://www.inaturalist.org/observations/dirkvdl16.json?layout=large&limit=10&order=desc&order_by=observed_on'
};
